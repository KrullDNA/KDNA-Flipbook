...
1. Go to **Plugins, Add New, Upload Plugin** and upload `kdna-flipbook-v1.0.2.zip`.
...
4. Optionally click **Choose icon** to set a small icon for the sidebar. If you
   skip this, a default document icon is used.
